...
to manipulate the type is the collection of data with values having fixed meaning as well as characteristics.
IN C used to: 
 ...
 * **Union** These allow storing various data types in the same memory location. 
  Programmers can define a union with different members, but only a single member 
...
| -- | -- |                                                                               | <     | Smaller than |
| >     | Greater than |                                                                  | <=    | smaller or equal than |
| >=    | Greater or equal than |                                                         | ==    | Equivalent |                                                                    
| !=    | Different than |
